  ...
  <footer class="footer">
    <div class="container footer__container">
      ...
      <div class="footer__info">
        ...
        <ul class="footer__list">
          <li class="footer__item">
            Designer:
            <a class="footer__link" href="https://t.me/Mrshmallowww" target="_blank"
              >Anastasia Ilina</a
            >
          </li>
        </ul>
      ...
      <address class="footer__contacts">
        <a class="footer__email" href="mailto:Petplanet@gmail.com">Petplanet@gmail.com</a>

        <ul class="footer__social-list">
          <li class="footer__item">
            <a class="footer__link" href="#" aria-label="Телеграм-бот petplanet">
              <svg
                width="32"
                height="32"
                viewBox="0 0 32 32"
          ...
          <li class="footer__item">
            <a class="footer__link" href="#" aria-label="Канал на youtube petplanet">
              <svg
                width="32"
                height="32"
                viewBox="0 0 32 32"
          ...
          <li class="footer__item">
            <a class="footer__link" href="#" aria-label="Группа в vk petplanet">
              <svg
                width="32"
                height="32"
                viewBox="0 0 32 32"
